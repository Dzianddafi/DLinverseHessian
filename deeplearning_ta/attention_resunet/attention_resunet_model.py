from .attention_resunet_parts import *


class AttentionResUNet(nn.Module):
    """Attention-based Residual U-Net (Attention ResUNet).
    ...
    The model is suitable for dense prediction tasks such as segmentation,
    inversion, and image-to-image regression.
    ...
    def forward(self, x):
        """Forward pass of the Attention ResUNet.
