...
def plot_shotrecord_cust(
    ...
    """
    Plot and compare  shot records side by side.
    ...
    Args:
        ...
        model (Model): Devito model object containing domain origin.
...
def plot_velocity_cust(
    ...
    """
    Plot a 2D velocity model with optional source and receiver locations.
    ...
    Args:
        model (Model): Devito model object containing velocity fields
